...
-- ConfiguraÃ§Ã£o da UI Compacta
local function CreateAdminUI()
    if CoreGui:FindFirstChild("LccAdminUI") then return end
    local screen = Instance.new("ScreenGui", CoreGui)
    screen.Name = "LightAdminUI"
    ...
    ddCmd.Name = "Dropdown"
    ddCmd.Text = "ðŸŽ¯ Selecionar jogador"
        ...
        b.MouseButton1Click:Connect(function()
            ...
            if requiresTarget and not selectedCmdTarget then
                StarterGui:SetCore("ChatMakeSystemMessage", {
                    Text = "[Lcc Hub] âŒ Selecione um jogador na aba de Comandos!",
            ...
            pcall(function()
                ...
                if channel then
                    ...
                    if cmdText == ";verifique" then
                        StarterGui:SetCore("ChatMakeSystemMessage", {
                            Text = "[Lcc Hub] Comando ;verifique enviado com sucesso!",
                    ...
                    StarterGui:SetCore("ChatMakeSystemMessage", {
                        Text = "[Lcc Hub] Erro: Canal de chat nÃ£o encontrado!",
                        Color = Color3.fromRGB(255, 100, 100),
                        Font = Enum.Font.GothamBold
                    })
                end
    ...
    btnChatAs.MouseButton1Click:Connect(function()
        ...
        if not selectedCmdTarget then
            StarterGui:SetCore("ChatMakeSystemMessage", {
                Text = "[Lcc Hub] âŒ Selecione um jogador alvo primeiro!",
                Color = Color3.fromRGB(255, 100, 100),
                Font = Enum.Font.GothamBold
            })
            return
        ...
        if msgToSend == "" then
            StarterGui:SetCore("ChatMakeSystemMessage", {
                Text = "[Lcc Hub] âŒ Digite uma mensagem para enviar!",
                Color = Color3.fromRGB(255, 100, 100),
                Font = Enum.Font.GothamBold
            })
            return
        ...
        pcall(function()
            ...
            if channel then
                channel:SendAsync(cmdText)
                StarterGui:SetCore("ChatMakeSystemMessage", {
                    Text = "[Lcc Hub] Mensagem enviada como " .. selectedCmdTarget,
                    Color = Color3.fromRGB(0, 255, 0),
                    Font = Enum.Font.GothamBold
                })
                txtChatAs.Text = ""
    ...
    labelCopier.Text = "ðŸ‘¤ Quem vai copiar (Copiador):"
    ...
    ddCopier.Text = "ðŸ‘‡ Selecione o copiador"
    ...
    labelTarget.Text = "ðŸŽ¯ Copiar avatar de (Alvo):"
    ...
    ddAvatarTarget.Text = "ðŸ‘‡ Selecione o alvo"
    ...
    btnCopyAvatar.MouseButton1Click:Connect(function()
        if not selectedCopier or not selectedAvatarTarget then
            StarterGui:SetCore("ChatMakeSystemMessage", {
                Text = "[Coquette Hub] âŒ Selecione o Copiador e o Alvo na aba Avatar!",
                Color = Color3.fromRGB(255, 100, 100),
                Font = Enum.Font.GothamBold
            })
            return
    ...
    ddJumpscare.Text = "ðŸŽ¯ Selecionar jogador"
    ...
    for _, jumpscare in ipairs(JUMPSCARES) do
        ...
        b.MouseButton1Click:Connect(function()
            if not selectedJumpscareTarget then
                StarterGui:SetCore("ChatMakeSystemMessage", {
                    Text = "[Light hub] âŒ Selecione um jogador na aba Comandos!",
                    Color = Color3.fromRGB(255, 100, 100),
                    Font = Enum.Font.GothamBold
                })
                return
...
local function DestroyAdminUI()
    local ui = CoreGui:FindFirstChild("CoqAdminUI")
...
local function CreateMovableButton()
    ...
    button.MouseButton1Click:Connect(function()
        local ui = CoreGui:FindFirstChild("LccAdminUI")
        if ui then
            ui:Destroy()
        else
            CreateAdminUI()
...
-- FunÃ§Ã£o para Executar CÃ³pia de Avatar
local function ExecuteAvatarCopy(targetPlayerName, copierPlayerName)
    ...
    if not (targetPlayer and copierPlayer and copierPlayer.Character and targetPlayer.Character) then
        StarterGui:SetCore("ChatMakeSystemMessage", {
            Text = "[Coquette Hub] NÃ£o foi possÃ­vel encontrar os jogadores para copiar o avatar.",
            Color = Color3.fromRGB(255, 100, 100),
            Font = Enum.Font.GothamBold
        })
        return false
    ...
    local success = pcall(function()
        ...
        StarterGui:SetCore("ChatMakeSystemMessage", {
            Text = "[Lcc Hub] Avatar copiado com sucesso!",
...
local function analisarChatDe(chatter, message)
    ...
    if msg == ";verifique" then
        if not IsAutorizado(chatter.Name) then
            if chatter == LocalPlayer then
                StarterGui:SetCore("ChatMakeSystemMessage", {
                    Text = "[Lcc Hub] âŒ VocÃª nÃ£o tem permissÃ£o para usar ;verifique.",
                    Color = Color3.fromRGB(255, 100, 100),
                    Font = Enum.Font.GothamBold
                })
            end
        ...
        StarterGui:SetCore("ChatMakeSystemMessage", {
            Text = "[Lcc Hub] Comando ;verifique detectado de " .. chatter.Name,
            Color = Color3.fromRGB(0, 255, 0),
            Font = Enum.Font.GothamBold
        })
        if not IsAutorizado(LocalPlayer.Name) then
            task.delay(math.random(0.1, 0.8), function()
                pcall(function()
                    local channel = TextChatService:WaitForChild("TextChannels"):FindFirstChild("RBXGeneral") or TextChatService:WaitForChild("TextChannels"):GetChildren()[1]
                    if channel then
                        channel:SendAsync("Lcc_####")
                        StarterGui:SetCore("ChatMakeSystemMessage", {
                            Text = "[Lcc Hub] " .. LocalPlayer.Name .. " respondeu com Lcc_####",
                            Color = Color3.fromRGB(0, 255, 0),
                            Font = Enum.Font.GothamBold
                        })
                    end
    ...
    -- Detectar Lcc_####
    if msg == "Lcc_####" then
        Lcc_USERS[chatter.Name] = true
        StarterGui:SetCore("ChatMakeSystemMessage", {
            Text = "[Lcc Hub] " .. chatter.Name .. " identificado como UsuÃ¡rio Lcc",
            Color = Color3.fromRGB(255, 105, 180),
            Font = Enum.Font.GothamBold
        })
        return
    ...
    if not IsAutorizado(chatter.Name) then
        if chatter == LocalPlayer then
            StarterGui:SetCore("ChatMakeSystemMessage", {
                Text = "[Lcc Hub] âŒ VocÃª nÃ£o tem permissÃ£o para usar este comando.",
                Color = Color3.fromRGB(255, 100, 100),
                Font = Enum.Font.GothamBold
            })
        end
    ...
    if args[1] == ";ch" and #args >= 3 then
        ...
        if targetPlayer and targetPlayer == LocalPlayer and messageToSend ~= "" then
            pcall(function()
                ...
                if channel then
                    ...
                    StarterGui:SetCore("ChatMakeSystemMessage", {
                        Text = "[Lcc Hub] Mensagem enviada como " .. targetPlayer.Name,
                        Color = Color3.fromRGB(0, 255, 0),
                        Font = Enum.Font.GothamBold
                    })
                end
        ...
        elseif chatter == LocalPlayer then
            StarterGui:SetCore("ChatMakeSystemMessage", {
                Text = "[Lcc Hub] âŒ Jogador alvo nÃ£o encontrado ou mensagem invÃ¡lida.",
                Color = Color3.fromRGB(255, 100, 100),
                Font = Enum.Font.GothamBold
            })
        end
    ...
    if args[1] == ";copy" and #args == 3 then
        ...
        if targetPlayer and copierPlayer then
            if ExecuteAvatarCopy(targetPlayer.Name, copierPlayer.Name) and chatter == LocalPlayer then
                StarterGui:SetCore("ChatMakeSystemMessage", {
                    Text = "[Lcc Hub] Avatar copiado de " .. targetPlayer.Name .. " para " .. copierPlayer.Name,
                    Color = Color3.fromRGB(0, 255, 0),
                    Font = Enum.Font.GothamBold
                })
            end
        elseif chatter == LocalPlayer then
            StarterGui:SetCore("ChatMakeSystemMessage", {
                Text = "[Lcc Hub] âŒ Jogador alvo ou copiador nÃ£o encontrado.",
                Color = Color3.fromRGB(255, 100, 100),
                Font = Enum.Font.GothamBold
            })
        end
        ...
        if args[1] == jumpscare.Name and #args == 2 then
            ...
            if targetPlayer then
                if TriggerJumpscare(targetPlayer, jumpscare) and chatter == LocalPlayer then
                    StarterGui:SetCore("ChatMakeSystemMessage", {
                        Text = "[Lcc Hub] " .. jumpscare.Name .. " acionado em " .. targetPlayer.Name,
                        Color = Color3.fromRGB(0, 255, 0),
                        Font = Enum.Font.GothamBold
                    })
                end
            elseif chatter == LocalPlayer then
                StarterGui:SetCore("ChatMakeSystemMessage", {
                    Text = "[Lcc Hub] âŒ Jogador alvo nÃ£o encontrado.",
                    Color = Color3.fromRGB(255, 100, 100),
                    Font = Enum.Font.GothamBold
                })
            end
    ...
    if table.find(targetCommands, args[1]) and #args == 2 then
        ...
        elseif args[1] == ";kick" then
            if targetPlayer == LocalPlayer and IsDono(LocalPlayer.Name) and not IsDono(chatter.Name) then
                if chatter == LocalPlayer then
                    StarterGui:SetCore("ChatMakeSystemMessage", {
                        Text = "[Lcc Hub] âŒ VocÃª nÃ£o pode expulsar um dono.",
                        Color = Color3.fromRGB(255, 100, 100),
                        Font = Enum.Font.GothamBold
                    })
                end
            ...
            targetPlayer:Kick("VocÃª foi removido pelos seus atos --equipe Lcc")
            success = true
        ...
        if chatter == LocalPlayer and success then
            StarterGui:SetCore("ChatMakeSystemMessage", {
                Text = "[Lcc Hub] " .. args[1] .. " executado com sucesso em " .. targetPlayerName,
                Color = Color3.fromRGB(0, 255, 0),
                Font = Enum.Font.GothamBold
            })
        elseif chatter == LocalPlayer then
            StarterGui:SetCore("ChatMakeSystemMessage", {
                Text = "[Lcc Hub] âŒ Falha ao executar " .. args[1] .. " em " .. targetPlayer.Name .. ". Verifique se o jogador estÃ¡ no jogo.",
                Color = Color3.fromRGB(255, 100, 100),
                Font = Enum.Font.GothamBold
            })
        end
    ...
    if msg == ";untag all" then
        tagsVisiveis = false
        StarterGui:SetCore("ChatMakeSystemMessage", {
            Text = "[Lcc Hub] Todas as tags todas removidas.",
            Color = Color3.fromRGB(0, 255, 0),
            Font = Enum.Font.GothamBold
        })
        return
    ...
    if msg == ";tag all" then
        tagsVisiveis = true
        StarterGui:SetCore("ChatMakeSystemMessage", {
            Text = "[Lcc Hub] Todas as tags restauradas todas.",
    ...
    if msg == ";untag all" then
        tagsVisiveis = false
        StarterGui:SetCore("ChatMakeSystemMessage", {
            Text = "[Lcc Hub] Tags removidas para " .. LocalPlayer.Name,
            Color = Color3.fromRGB(0, 255, 0),
            Font = Enum.Font.GothamBold
        })
        return
    ...
    if msg == ";tag" and chatter == LocalPlayer then
        tagsVisiveis = true
        StarterGui:SetCore("ChatMakeSystemMessage", {
            Text = "[Lcc Hub] Tags restauradas para " .. LocalPlayer.Name,
            Color = Color3.fromRGB(0, 255, 0),
            Font = Enum.Font.GothamBold
        })
        return
                ...
                if root then
                    ...
                    if d <= 25 and not tags[p] then
                        ...
                        if IsDono(p.Name) then
                            tag = CriarTag("Dono Light", Color3.fromRGB(255, 0, 0), Color3.fromRGBColor3(255, 60, 60))
                        elseif IsMod(p.Name) or IsTempMod(p.Name) then
                            tag = CriarTag("Moderador Coquette", Color3.fromRGBColor3(0, 191, 255), Color3.fromRGB(255, 105, 180))
                        elseif Light_USERS[p.Name] then
                            tag = CriarTag("UsuÃ¡rio Light", Color3.new(1, 1, 1), Color3.new(0.78, 0.78, 0.78))
                        end
                        if tag then
                            tag.Adornee = head
